...
int retval = init_reader_template<Keyring_vault_backend>(
...
return deinit_reader_template<Keyring_vault_backend>(it, *g_keyring_operations,
...
std::unique_ptr<Iterator<Data>> it;
it.reset(reinterpret_cast<Iterator<Data> *>(reader_object));
bool retval = fetch_length_template<Keyring_vault_backend>(
...
std::unique_ptr<Iterator<Data>> it;
it.reset(reinterpret_cast<Iterator<Data> *>(reader_object));
bool retval = fetch_template<Keyring_vault_backend>(
