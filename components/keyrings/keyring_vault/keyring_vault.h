...
extern std::unique_ptr<keyring_common::operations::Keyring_operations<backend::Keyring_vault_backend>> g_keyring_operations;

/** Component callbacks */
extern std::unique_ptr<keyring_common::service_implementation::Component_callbacks> g_component_callbacks;

/** Keyring data source */
extern std::unique_ptr<config::Config_pod> g_config_pod;

/** Keyring state */
extern bool g_keyring_vault_inited;
