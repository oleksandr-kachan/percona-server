...
struct promise_type {
  ...
  ParserGenerator get_return_object() { return ParserGenerator{*this}; }
  std::suspend_always initial_suspend() noexcept { return {}; }
  std::suspend_always yield_value(ParserResult result) noexcept {
    m_parser_result = result;
    return {};
  }
  void return_value(ParserResult result) { m_parser_result = result; }
...
class iterator {
 public:
//  iterator() = default;
  explicit iterator(ParserGenerator *generator) : m_generator{generator} {}
